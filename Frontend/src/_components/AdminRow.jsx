  ...
  return (
    <div className="mb-8 mx-5">
      <div className="flex justify-between" >
        ...
        <span className="flex items-center text-lg text-[#444] gap-4 font-syncopate-light">
              ...
              <div key={index} className="grid grid-flow-col">
                <div className="w-full grid grid-cols-3  border-r-0 border-[#999] border-solid border-b lg:p-1 lg:px-5 p-1 pl-2 text-xs ">
                  ...
                  <div className="col-span-2">
                    <input type={ ['wallet' ,'investment', 'gross_profit'].includes(field)?'number':(field==='begin_date'?'date':'text') } className="font-syncopate-light text-[#555] w-[400px]" onChange={(e)=>onChangeData(e,field)} disabled={!editFlag} defaultValue={data[field]} />
                  </div>
                </div>
              </div> 
            )
