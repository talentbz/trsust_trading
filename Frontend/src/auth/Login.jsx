...
function Login() {
    ...
    return (
      <>
        ...
        <div className="md:hidden grid place-items-center px-[20px]">
          <Credentials>
            <form
              method="post" onSubmit={handleSubmit(onSubmit)}
              className="bg-gradient-to-b from-[rgb(160,91,255)] from-10% to-100% to-[rgb(215,215,216)] w-auto h-full flex justify-center items-center flex-col px-10 py-8 dark:from-[rgb(147, 39, 232)] dark:to-[#454555] dark:from-0 dark:to-90%">
              ...
              <div className="mt-10 w-full flex justify-center items-center flex-col">
                <input
                className={`bg-transparent border-b-[1px] border-black font-roboto outline-none p-2 text-white placeholder:text-[rgb(107,102,109)] w-auto ${errors.username ? 'is-invalid' : ''} dark:placeholder:text-[#fff] dark:border-white`}
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Email *"
                ...
                <div className='relative'>
                  <input
                    className={`bg-transparent border-b-[1px] border-black font-roboto outline-none p-2 text-white placeholder:text-[rgb(107,102,109)] mt-5 w-auto ${errors.password ? 'is-invalid' : ''} dark:placeholder:text-[#fff] dark:border-white`}
                    type={isEye?"password": "text"}
                    name="password"
                    id="password"
                    placeholder="Password *"
